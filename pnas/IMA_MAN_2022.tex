...
\pagestyle{headings}
\markboth{\rm EXACT OPTIMIZATION: PART I}{\rm EXACT OPTIMIZATION: PART I}
%\markboth{L.-G. LIN and Y.-W. LIANG}{\rm EXACT OPTIMIZATION: PART I}
\maketitle

%%%%%%%%%%%%%%%%%abstract style
% According to IMA-MAN website, <= 200 words, 3~5 keywords according to submission website
...
\newpage\item[$\bullet$] QP problems subject to inequality constraints only, being applicable (that is, solvable) after a simple replacement of parameters in the algorithm.
\end{enumerate}
